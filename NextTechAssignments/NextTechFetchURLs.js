...
(async function fetchData(dataArray = []) {
    ...
    const urlArray = [
      'https://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=b91445bba46412073ea524bdc04b9cee',
      'https://api.openweathermap.org/data/2.5/weather?q=Houston&APPID=b91445bba46412073ea524bdc04b9cee',
      'https://api.openweathermap.org/data/2.5/weather?q=Lisbon&APPID=b91445bba46412073ea524bdc04b9cee',
      'https://api.openweathermap.org/data/2.5/weather?q=Baltimore&APPID=b91445bba46412073ea524bdc04b9cee',
    ];
