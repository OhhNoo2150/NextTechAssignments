...
function addItemToArray(arr, item) {
  arr.push(item);// add the parameter item to the end of the array arr
  return arr; // return the array
}

function addItemToFront(arr, item) {
  arr.unshift(item);// add the parameter item to the front of the array arr
  // return the array
  return arr; // hint: use the array method .unshift
}
